...
1. [Sample6: Mount secret volumes to deployment](sample6/)
1. [Sample7: Mount config map volumes to deployment](sample7/)
1. [Sample8: Mount PersistentVolumeClaim to deployment](sample8/)
1. [Sample9: Ballerina module with kubernetes annotations](sample9/)
1. [Sample10: Kubernetes Hello World with Ballerina Function](sample10/)
1. [Sample11: Copy External files to Docker Image](sample11/) 
1. [Sample12: Ballerina modules with dependencies](sample12/) 
1. [Sample13: Deploy Ballerina service in a namespace](sample13/)
1. [Sample14: Resource quotas for namespaces](sample14/) 
1. [Sample15: Istio Gateway and Virtual Service generation](sample15/)  (Does not need setting up nginx)