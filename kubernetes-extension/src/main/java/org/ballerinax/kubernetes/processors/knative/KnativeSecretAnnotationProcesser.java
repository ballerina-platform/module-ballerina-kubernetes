    ...
    private void processSecret(IdentifierNode nodeID, AnnotationAttachmentNode attachmentNode) throws
        ...
        for (BLangRecordLiteral.BLangRecordKeyValue keyValue : keyValues) {
            ...
            for (BLangExpression bLangExpression : secretAnnotation) {
                org.ballerinax.kubernetes.models.knative.SecretModel secretModel = new SecretModel();
                ...
                for (BLangRecordLiteral.BLangRecordKeyValue annotation : annotationValues) {
                    KnativeSecretAnnotationProcesser.SecretMountConfig secretMountConfig =
                            KnativeSecretAnnotationProcesser.SecretMountConfig.valueOf(annotation.getKey().toString());
